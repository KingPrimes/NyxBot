...
@Shiro
@Component
public class SortiesPlugin extends AbstractWorldStatePlugin {

    public SortiesPlugin(DrawImagePlugin drawImagePlugin, WorldStateUtils worldStateUtils) {
    ...
    protected Codes getCode() {
        return Codes.WARFRAME_SORTIES_PLUGIN;
    }
}
