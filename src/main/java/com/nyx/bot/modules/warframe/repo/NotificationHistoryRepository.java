...
public interface NotificationHistoryRepository extends JpaRepository<NotificationHistory, Long> {
     ...
     * @return 如果已存在返回 true
     */
    boolean existsBySubscribeTypeAndExpiryTimestamp(SubscribeType subscribeType, Long expiryTimestamp);
     ...
     * @return 通知历史记录
     */
    Optional<NotificationHistory> findBySubscribeTypeAndExpiryTimestamp(SubscribeType subscribeType, Long expiryTimestamp);
     ...
     * @return 删除的记录数
     */
    long deleteBySubscribeTypeAndNotifiedAtBefore(SubscribeType subscribeType, Instant before);
}