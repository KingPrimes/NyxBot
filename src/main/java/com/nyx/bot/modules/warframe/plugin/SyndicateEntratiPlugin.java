...
public class SyndicateEntratiPlugin {
    ...
    public void syndicateEntranceHandler(Bot bot, AnyMessageEvent event) {
        OneBotLogInfoData logInfoData = WarframeSend.getLogInfoData(bot, event, Codes.WARFRAME_SYNDICATE_ENTRATI);
        logInfoData.setData(SyndicateEnum.EntratiSyndicate.name());
