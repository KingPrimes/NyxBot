...
import com.nyx.bot.utils.image.jhlabs.math.Function2D;
import com.nyx.bot.utils.image.jhlabs.math.ImageFunction2D;
import com.nyx.bot.utils.image.jhlabs.vecmath.Color4f;
import com.nyx.bot.utils.image.jhlabs.vecmath.Vector3f;
...
//				v = v > 0.5f ? 0.5f : v;
                                ...
                                case 2 -> v = Math.max(v, 0.5f);
                                case 3 -> v = ImageMath.triangle(v);
                                case 4 -> v = ImageMath.circleDown(v);
                                case 5 -> v = ImageMath.gain(v, 0.75f);
                            }
                            return v;
                        }
                    };
        ...
        for (Light light : lightsArray) light.prepare(width, height);
