...
public interface RivenTrendRepository extends JpaRepository<RivenTrend, Long>, JpaSpecificationExecutor<RivenTrend> {
    ...
    @Query("select new com.nyx.bot.entity.warframe.RivenTrend(rt.id,rt.trendName,rt.newDot,rt.newNum,rt.oldDot,rt.oldNum,rt.type,t.cn) from RivenTrend rt left join Translation t on rt.trendName = t.en where rt.trendName like concat('%',:trendName,'%') ")
